...
impl Future for Pipe {
    ...
    fn poll(&mut self) -> Poll<(), Error> {
        // loop {
            ...
            // let v = Packet { bytes: [
            //   0x4f, 0x00, 0x00, 0x00, 0x0a, 0x35, 0x2e, 0x36, 0x2e, 0x34, 0x30, 0x2d, 0x38, 0x34, 0x2e, 0x30, 0x00, 0x09, 0x00, 0x00, 0x00, 0x46, 0x77, 0x48, 0x3d, 0x3c, 0x53, 0x6d, 0x4b, 0x00, 0xff, 0xf7, 0x08, 0x02, 0x00, 0x7f, 0x80, 0x15, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x6e, 0x66, 0x39, 0x28, 0x58, 0x66, 0x78, 0x47, 0x3a, 0x2a, 0x64, 0x39, 0x00, 0x6d, 0x79, 0x73, 0x71, 0x6c, 0x5f, 0x6e, 0x61, 0x74, 0x69, 0x76, 0x65, 0x5f, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x00,
            //   0x07, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00 ].to_vec()
            // };
            // self.client_writer.push(&v);
            ...
            // let v = Packet { bytes: [
            //   0x01, 0x00, 0x00, 0x01, 0x01, 0x27, 0x00, 0x00, 0x02, 0x03, 0x64, 0x65, 0x66, 0x00, 0x00, 0x00, 0x11, 0x40, 0x40, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x00, 0x0c, 0x21, 0x00, 0x9c, 0x00, 0x00, 0x00, 0xfd, 0x00, 0x00, 0x1f, 0x00, 0x00, 0x05, 0x00, 0x00, 0x03, 0xfe, 0x00, 0x00, 0x02, 0x00, 0x35, 0x00, 0x00, 0x04, 0x34, 0x50, 0x65, 0x72, 0x63, 0x6f, 0x6e, 0x61, 0x20, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x20, 0x28, 0x47, 0x50, 0x4c, 0x29, 0x2c, 0x20, 0x52, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x20, 0x38, 0x34, 0x2e, 0x30, 0x2c, 0x20, 0x52, 0x65, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x20, 0x34, 0x37, 0x32, 0x33, 0x34, 0x62, 0x33, 0x05, 0x00, 0x00, 0x05, 0xfe, 0x00, 0x00, 0x02, 0x00
            // ].to_vec()
            // };
            // self.client_writer.push(&v);
...
//             let client_read = self.client_reader.read();
//             while let Some(_request) = self.client_reader.next() {
//             }
//             try_ready!(client_read);

//             let v = Packet { bytes: [
// 0x01, 0x00, 0x00, 0x01, 0x01, 0x17, 0x00, 0x00,
// 0x02, 0x03, 0x64, 0x65, 0x66, 0x00, 0x00, 0x00,
// 0x01, 0x31, 0x00, 0x0c, 0x3f, 0x00, 0x01, 0x00,
// 0x00, 0x00, 0x08, 0x81, 0x00, 0x00, 0x00, 0x00,
// 0x05, 0x00, 0x00, 0x03, 0xfe, 0x00, 0x00, 0x02,
// 0x00, 0x02, 0x00, 0x00, 0x04, 0x01, 0x31, 0x05,
// 0x00, 0x00, 0x05, 0xfe, 0x00, 0x00, 0x02, 0x00 ].to_vec()};
//             self.client_writer.push(&v);
//             let client_write = self.client_writer.write();
//             try_ready!(client_write);
